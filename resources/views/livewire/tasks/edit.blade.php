                        ...
                        <form>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    @error('form.text') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a href="{{ route('tasks.index') }}" class="btn btn-secondary me-2">Back</a>
                                <button type="button" class="btn btn-primary" wire:click="update">Update Task</button>
                            </div>
                        </form>
                    </div>
